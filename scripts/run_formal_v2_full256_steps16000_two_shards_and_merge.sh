...
BASE_FAMILY_NAME="${BASE_FAMILY_NAME:-formal_v2_full256_steps16000}"
...
LOG_DIR="${LOG_DIR:-logs/formal_v2_full256_steps16000}"

if [[ -f "/root/miniconda3/etc/profile.d/conda.sh" ]]; then
  source /root/miniconda3/etc/profile.d/conda.sh
else
  echo "[run_formal_v2_full256_steps16000_two_shards_and_merge] missing /root/miniconda3/etc/profile.d/conda.sh"
  exit 1
fi
